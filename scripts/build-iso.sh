...
<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
  <defs>
    ...
    <linearGradient id="badge" x1="26" y1="24" x2="78" y2="48" gradientUnits="userSpaceOnUse">
    ...
    <filter id="glyphLift" x="-28%" y="-28%" width="156%" height="156%">
      <feDropShadow dx="3" dy="5" stdDeviation="2" flood-color="#000814" flood-opacity="0.62"/>
    </filter>
  </defs>
  ...
  <rect x="28" y="29" width="52" height="21" rx="8" fill="#020814" opacity="0.5"/>
  <rect x="25" y="24" width="52" height="21" rx="8" fill="url(#badge)" stroke="${accent}" stroke-width="1.7"/>
  <path d="M31 27h38" fill="none" stroke="#ffffff" stroke-width="1.4" stroke-linecap="round" opacity="0.2"/>
  <text x="52" y="40" text-anchor="middle"
        font-family="Cantarell, Inter, Arial, sans-serif" font-size="10.5" font-weight="800"
        fill="#e8fbff" stroke="#000814" stroke-width="0.7" paint-order="stroke">${label}</text>
  <path d="${glyph}" fill="none" stroke="#020814" stroke-width="11" stroke-linecap="round" stroke-linejoin="round" opacity="0.58" transform="translate(4 5)"/>
  <path d="${glyph}" fill="none" stroke="#0b1724" stroke-width="9" stroke-linecap="round" stroke-linejoin="round" opacity="0.72" transform="translate(2 3)"/>
  <path d="${glyph}" fill="none" stroke="#ffffff" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" opacity="0.18" transform="translate(-1 -1)"/>
  <path d="${glyph}" fill="none" stroke="${accent}" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" filter="url(#glyphLift)"/>
  <path d="${glyph}" fill="none" stroke="#f7fdff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" opacity="0.72" transform="translate(-1 -1)"/>
</svg>
EOF
}
